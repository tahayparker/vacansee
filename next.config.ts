...
const nextConfig: NextConfig = { // Use NextConfig type
  ...
  async redirects() {
    return [
      ...
      { source: '/CurrentlyAvailable', destination: '/available-now', permanent: true },
      { source: '/availablenow', destination: '/available-now', permanent: true },
      { source: '/AvailableNow', destination: '/available-now', permanent: true },
      { source: '/currentlyavailable', destination: '/available-now', permanent: true },
      ...
      { source: '/graphs', destination: '/graph', permanent: true }, // Plural to singular
       ...
       { source: '/AvailableSoon', destination: '/available-soon', permanent: true },
       { source: '/availablesoon', destination: '/available-soon', permanent: true },
