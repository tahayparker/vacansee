...
export function createSupabaseServerClient(context: GetServerSidePropsContext) {
    console.log('[createSupabaseServerClient] Using cookie options:', cookieOptions); // Add log
...
export function createSupabaseRouteHandlerClient(req: NextApiRequest, res: NextApiResponse) {
    console.log('[createSupabaseRouteHandlerClient] Using cookie options:', cookieOptions); // Add log
