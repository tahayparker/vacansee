...
import { ListChecks, Cpu, Terminal, GitBranch, Mail, Info, Target, Settings } from 'lucide-react';
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-6 pt-20 md:pt-24 flex-grow flex flex-col text-white">
      ...
      >
        ...
        <motion.div variants={sectionVariant} className="text-center mb-12"> {/* Increased mb */}
          {/* Using Settings icon for general info */}
          <Settings className="mx-auto h-12 w-12 text-purple-400 mb-4" />
          <h1 className="text-4xl md:text-5xl font-bold text-white/95">vacansee Documentation</h1>
          <p className="text-lg text-white/70 mt-2">Overview, Features, and Setup Information.</p>
        </motion.div>
        ...
        <motion.section variants={sectionVariant} className="space-y-4">
           <div className="flex items-center gap-3 border-b border-white/20 pb-2 mb-3">
             ...
             <h2 className="text-2xl font-semibold text-white/90">What is vacansee?</h2>
           </div>
        ...
        <motion.section variants={sectionVariant} className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-white/80 pl-1 text-lg">
            ...
            <motion.li variants={listItemVariant}>Fuzzy Search for Rooms (Check & Custom Graph)</motion.li>
            <motion.li variants={listItemVariant}>Automatic Timetable Updates</motion.li>
            <motion.li variants={listItemVariant}>Mobile Responsive Design</motion.li>
            <motion.li variants={listItemVariant}>Secure Authentication (Google/GitHub)</motion.li>
          </ul>
        </motion.section>
        ...
        <motion.section variants={sectionVariant} className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-white/80 pl-1 text-lg">
            <motion.li variants={listItemVariant}><strong>Frontend:</strong> Next.js (Pages Router), TypeScript, Tailwind CSS, Shadcn UI, Framer Motion</motion.li>
            <motion.li variants={listItemVariant}><strong>Backend:</strong> Next.js API Routes, Prisma ORM</motion.li>
            <motion.li variants={listItemVariant}><strong>Database:</strong> PostgreSQL (hosted on Supabase)</motion.li>
            <motion.li variants={listItemVariant}><strong>Authentication:</strong> Supabase Auth (OAuth)</motion.li>
            <motion.li variants={listItemVariant}><strong>Deployment & Analytics:</strong> Vercel</motion.li>
            <motion.li variants={listItemVariant}><strong>Styling:</strong> Tailwind CSS, CSS Modules</motion.li>
            <motion.li variants={listItemVariant}><strong>Data Handling:</strong> Python scripts (Scraping & Schedule Generation)</motion.li>
             <motion.li variants={listItemVariant}><strong>Libraries:</strong> Fuse.js, Luxon, date-fns, Lucide Icons</motion.li>
          </ul>
        </motion.section>
        ...
        <motion.section variants={sectionVariant} className="space-y-4">
           <div className="flex items-center gap-3 border-b border-white/20 pb-2 mb-3">
             ...
             <h2 className="text-2xl font-semibold text-white/90">Getting Started (Development)</h2>
           </div>
          <p className="text-white/80 text-lg">To set up the project locally:</p>
          <ol className="list-decimal list-inside space-y-2 text-white/80 pl-1 text-lg">
            <motion.li variants={listItemVariant}>Clone the repository from GitHub.</motion.li>
            <motion.li variants={listItemVariant}>Install dependencies using `npm install` or `yarn install`.</motion.li>
            <motion.li variants={listItemVariant}>Create a `.env` file with Supabase/Prisma connection details.</motion.li>
            <motion.li variants={listItemVariant}>Initialize the database schema: `npx prisma db push`.</motion.li>
        ...
        <motion.section variants={sectionVariant} className="space-y-4">
           <div className="flex items-center gap-3 border-b border-white/20 pb-2 mb-3">
             ...
             <h2 className="text-2xl font-semibold text-white/90">Automatic Updates</h2>
           </div>
          <p className="text-white/80 text-lg">
            {/* Updated frequency */}
        ...
        <motion.section variants={sectionVariant} className="space-y-4">
           ...
           <p className="text-white/80 text-lg">
             ...
             <Link href="https://tahayparker.vercel.app/contact" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline ml-1">website</Link>.
           </p>
           <p className="text-white/80 text-lg">
             Project Link: <Link href="https://github.com/tahayparker/vacansee" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">https://github.com/tahayparker/vacansee</Link>
           </p>
        </motion.section>
