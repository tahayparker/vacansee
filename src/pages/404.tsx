...
export default function Custom404() {
  ...
  return (
    <div className="space-y-4 text-center py-10"> {/* Removed all flex/grow/h-full properties */}
      <AlertTriangle className="mx-auto h-16 w-16 text-yellow-500" />
      <h1 className="text-4xl sm:text-5xl font-bold text-white/90">Error 404</h1>
