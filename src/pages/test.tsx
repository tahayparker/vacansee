  ...
  return (
    ...
    <div className={`relative min-h-screen`}>
      ...
      <div className="relative z-10 grid min-h-screen place-items-center p-8">
        ...
        {/* Content Area */}
        <div className="w-full max-w-2xl space-y-6 text-white"> {/* Max width for readability */}
          {/* Page Title */}
          <h1 className="text-4xl font-bold tracking-tight text-center"> {/* Centered Title */}
            Test
          </h1>

          {/* Body Text */}
          <div className="space-y-4 text-lg text-gray-200"> {/* Lighter text color for paragraphs */}
            <p>
