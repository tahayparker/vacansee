      ...
      >
        ...
        <motion.section variants={listItemVariants} className="space-y-3">
          ...
          <p className="text-white/80 text-justify">
            This Privacy Policy explains how <strong>vacansee</strong>{" "}
            (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;, or &quot;the
          ...
          <p className="text-white/80 text-justify">
            ...
            using vacansee, you acknowledge that you have read, understood, and
        ...
        <motion.section variants={listItemVariants} className="space-y-3">
          ...
          <div className="text-white/80 space-y-2 text-justify">
            ...
            <p>
              <strong>Controller:</strong> vacansee, which determines the
        ...
        <motion.section variants={listItemVariants} className="space-y-3">
          ...
          <div className="text-white/80">
            <p>
              <strong>Controller Name:</strong> vacansee
            </p>
            <p>
        ...
        <motion.section variants={listItemVariants} className="space-y-3">
          ...
          <ul className="list-disc list-inside space-y-1 text-white/80 pl-4">
            ...
            <li>
              Protect the rights, property, safety, or security of vacansee, our
