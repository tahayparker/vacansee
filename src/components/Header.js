...
const Header = ({ hideLogoOnHome }) => {
  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-black/30 border-b border-[#482f1f]">
        <div className="flex items-center justify-between h-[70] px-4">
